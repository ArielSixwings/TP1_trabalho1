...
CREATE TABLE IF NOT EXISTS Vehicle(
	...
	FOREIGN KEY(Model) REFERENCES Model(Name) ON DELETE CASCADE
	);

CREATE TABLE IF NOT EXISTS Alocation(
	AlocationId INTEGER PRIMARY KEY,
	Vehicle INTEGER NOT NULL,
	TypeAloc VARCHAR(8) NOT NULL,
	CustomerCPF CHAR(11) NOT NULL,
	Price REAL NOT NULL,
	AlocationData VARCHAR(10) NOT NULL,
	AlocationHour VARCHAR(5) NOT NULL,
	DevolutionData VARCHAR(10),
	DevolutionHour VARCHAR(5),
	Agency VARCHAR(3) NOT NULL,
	FOREIGN KEY(CustomerCPF) REFERENCES Person(CPF) ON DELETE CASCADE
	FOREIGN KEY(Vehicle) REFERENCES Vehicle(VehicleKey) ON DELETE CASCADE
	FOREIGN KEY(Agency) REFERENCES Agency(agencyId) ON DELETE CASCADE
	);
